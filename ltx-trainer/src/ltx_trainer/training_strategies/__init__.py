...
TrainingStrategyConfig = TextToVideoConfig | VideoToVideoConfig | SCDTrainingConfig | VFMSCDDistillConfig | VFMSCDTrainingConfig | VFMTrainingConfig | VFMv1bTrainingConfig | VFMv1cTrainingConfig | VFMv1dTrainingConfig | VFMv1eTrainingConfig | VFMv1fTrainingConfig | VFMv12fTrainingConfig | VFMv1gTrainingConfig | VFMv1hTrainingConfig | VFMv2aTrainingConfig | VFMv2bTrainingConfig | DMDVFMv3aTrainingConfig | SelfEVFMv3bTrainingConfig | VFMv4aConfig | VFMDistillConfig | IsoGenTrainingConfig | OmniTransferConfig
...
def get_training_strategy(config: TrainingStrategyConfig) -> TrainingStrategy:
    ...
    match config:
        ...
        case OmniTransferConfig():
            from ltx_trainer.omnitransfer.strategy import OmniTransferStrategy  # noqa: PLC0415
